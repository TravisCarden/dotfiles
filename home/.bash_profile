...
alias phpdoc="~/.composer/vendor/bin/phpDocumentor.phar --target=var/phpdoc/docs --cache-folder=var/phpdoc/cache --directory=src --force; open var/phpdoc/docs/index.html"
